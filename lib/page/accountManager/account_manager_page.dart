...
import 'package:firebase_write/page/accountManager/account_group_register_dialog.dart';
...
import 'package:firebase_write/page/accountManager/account_register_dialog.dart';
...
class _MainPage extends State<AccountManagerPage> {
  ...
  DragAndDropList _groupPanel(AccountManagerGroupRegister group){
    group.sort();    
